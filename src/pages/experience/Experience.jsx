...
const Experience = () => {
  ...
  if (state.loading[key] && !experiences)
    return <div className="experience-page">Loading projects...</div>;
  if (state.error[key])
    return (
    ...
    <div className="experience-page">
      <div className="experience-hero">
        ...
        <p className="section-desc">
          2.6+ years of professional development and leadership
        </p>
      </div>
...
const ExperienceCard = ({ experience, delay, index }) => {
  const spring = useSpring({
    from: { opacity: 0, x: index % 2 === 0 ? -40 : 40 },
    to: { opacity: 1, x: 0 },
    delay,
  });
